                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" action="{{ route('event.store') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" id="organizer" name="organizer" placeholder="Enter Organizer">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" id="location_city" name="location_city" placeholder="Enter Location City">
